...
# class
class CMPMeanQuantSignLion(Optimizer):
    def __init__(
        self, 
        params, 
        lr: float = 1e-4, 
    ...
    def step(self, closure: Optional[Callable] = None):
        ...
        update_vector, update_vector_full = compute_updates_sign_int8(params, grads, exp_avgs, lr, wd, beta1, s = self.s, clip = self.clip)
