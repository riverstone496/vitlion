...
def mean_quantize(tensor, max_level, quantize_eps = 1e-12):
    """
    ...
    """
    mean_val = torch.exp(torch.mean(torch.log(torch.abs(tensor) + quantize_eps)))
